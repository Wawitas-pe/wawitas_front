...
const PostService = {
    ...
    getAllPosts: async () => {
        try {
            const response = await apiClient.get(URL_PREFIX+'/list');
    ...
    createPost: async (postData) => {
        try {
            const response = await apiClient.post(URL_PREFIX+'/new-post', postData);
    ...
    updateLikes: async (postId, newLikesCount) => {
        try {
            const response = await apiClient.patch(`${URL_PREFIX}/posts/${postId}`, { likes: newLikesCount });
    ...
    addComment: async (post) => {
        try {
            ...
            const response = await apiClient.patch(`${URL_PREFIX}/posts/${post.id}`, { comentarios: post.comentarios });
